...
def print_model_parm_flops(model, input, detail=False):
    ...
    if detail:
        ...
        print('  + Conv FLOPs: ', (sum(list_conv)))
        print('  + Linear FLOPs: ', (sum(list_linear)))
        print('  + Batch Norm FLOPs: ', (sum(list_bn)))
        print('  + Relu FLOPs: ', (sum(list_relu)))
        print('  + Pooling FLOPs: ', (sum(list_pooling)))
